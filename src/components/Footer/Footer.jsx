...
import "./footer.css";
import Unicus_icon  from "./../../assets/Unicus_icon.png";
        ...
        <div className="footer-content">
          <div className="footer-left">
            <div className="footer-leftleft">
              <img src={Unicus_icon} alt="Unicus" className="footer-logo" />
          ...
          <div className="footer-middle">
            <div className="footer-column">
              ...
              <ul>
                <li>
                  Web Design <br></br>and Programming
                </li>
                <li>Cybersecurity</li>
                <li>Product Deign</li>
                <li>Data Analysis</li>
          ...
          <div className="footer-right">
            ...
            <p>
              <i className="fas fa-phone-alt"></i> +234 706 611 2211
            </p>
            <p>
              <i className="fas fa-envelope"></i> support@unicus.live
            </p>
          </div>
        </div>
